...
class ParameterType(StrEnum):
    """Parameter types available in aquordion."""
...
class Interaction(StrEnum):
    ...
    - `RydbergDevice`.
    - [`hamiltonian_factory`][aquordion.constructors.hamiltonians.hamiltonian_factory].
    """
...
# If proprietary aquordion_extensions is available, import the
# right function since more backends are supported.
try:
    module = importlib.import_module("aquordion_extensions.types")

...
def test_vqe_pyq(
    ...
    opt_pyq = vqe_pyq_adam(circ, obs, inputs_embedded, n_shots=1000, N_epochs=10)
...
def test_vqe_horqrux(
    ...
    opt_horqux = vqe_horqrux_adam(ansatz, observable, init_param_vals, n_shots=1000, N_epochs=10)

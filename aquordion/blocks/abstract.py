...
from aquordion.types import TNumber
...
class AbstractBlock(ABC):
    ...
    def qubit_support(self) -> Tuple[int, ...]:
        ...
        aquordion uses the ordering [0..,N-1] for qubits.
        """
        pass
    ...
    def eigenvalues(
        ...
        from aquordion.utils import eigenvalues
    ...
    def __mul__(self, other: Union[AbstractBlock, TNumber, Parameter]) -> AbstractBlock:
        from aquordion.blocks.primitive import ScaleBlock
    ...
    def __imul__(self, other: Union[AbstractBlock, TNumber, Parameter]) -> AbstractBlock:
        from aquordion.blocks.composite import ChainBlock
        from aquordion.blocks.primitive import ScaleBlock
        from aquordion.blocks.utils import chain
    ...
    def __add__(self, other: AbstractBlock) -> AbstractBlock:
        from aquordion.blocks.utils import add
    ...
    def __iadd__(self, other: AbstractBlock) -> AbstractBlock:
        from aquordion.blocks.composite import AddBlock
        from aquordion.blocks.utils import add
    ...
    def __matmul__(self, other: AbstractBlock) -> AbstractBlock:
        from aquordion.blocks.utils import kron
    ...
    def __imatmul__(self, other: AbstractBlock) -> AbstractBlock:
        from aquordion.blocks.composite import KronBlock
        from aquordion.blocks.utils import kron
    ...
    def is_parametric(self) -> bool:
        from aquordion.blocks.utils import parameters
    ...
    def _is_diag_pauli(self) -> bool:
        from aquordion.blocks import CompositeBlock, PrimitiveBlock, ScaleBlock
        from aquordion.blocks.utils import block_is_qubit_hamiltonian

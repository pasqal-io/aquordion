...
class MatrixBlock(PrimitiveBlock):
    ...
    from aquordion.blocks.matrix import MatrixBlock
    from aquordion.operations import X, Z
    from aquordion.states import random_state
    ...
    def expand_to(self, n_qubits: int = 1) -> torch.Tensor:
        from aquordion.blocks.block_to_tensor import _fill_identities

...
from aquordion.blocks.utils import get_pauli_blocks, unroll_block_with_scaling
from aquordion.parameters import Parameter, evaluate

# from aquordion.types import TNumber, TParameter
from aquordion.types import PI
from aquordion.types import LTSOrder as Order
...
def change_to_z_basis(block: AbstractBlock, sign: int) -> list[AbstractBlock]:
    ...
    from aquordion.operations import RX, H, X, Y
...
def decompose_pauli_exp(block_list: list, parameter: Parameter | sympy.Expr) -> list[AbstractBlock]:
    ...
    # import here due to circular import issue
    from aquordion.operations import CNOT, RZ

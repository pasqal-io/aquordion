...
from aquordion.blocks import AbstractBlock, AnalogBlock, CompositeBlock, chain
from aquordion.blocks.utils import parameters, primitive_blocks, unique_parameters
...
class QuantumCircuit:
    ...
    def _from_dict(cls, d: dict) -> QuantumCircuit:
        ...
        RootBlock = (
            ...
            else getattr(aquordionblocks, d["block"]["type"])
        )

...
from aquordion.blocks import AbstractBlock, TimeEvolutionBlock
from aquordion.blocks.block_to_tensor import block_to_tensor
from aquordion.blocks.utils import (
    add,  # noqa
...
from aquordion.decompose import lie_trotter_suzuki
from aquordion.parameters import (
    Parameter,
    ParamMap,
    evaluate,
    extract_original_param_entry,
)
from aquordion.types import LTSOrder, OpName, TGenerator, TParameter
...
class HamEvo(TimeEvolutionBlock):
    ...
    from aquordion import X, HamEvo, PI, add, run
    from aquordion import FeatureParameter, TimeParameter
    import torch
    ...
    def __init__(
        ...
        if isinstance(generator, AbstractBlock):
            ...
            if len(generator.shape) == 2:
                ...
                assert generator.shape[0] == 1, "aquordion doesnt support batched generators."
            else:
                raise TypeError(

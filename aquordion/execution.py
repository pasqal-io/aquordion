...
from aquordion.types import BackendName, DiffMode, Endianness
...
def run(
    ...
    *args: Any,
    ...
    See the examples of the [`expectation`][aquordion.execution.expectation] function. This function
...
def expectation(
    ...
    from aquordion import RX, Z, Register, QuantumCircuit, expectation

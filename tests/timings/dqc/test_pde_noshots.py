...
from aquordion.dqc_benchmarks import dqc_pyq_adam, dqc_horqrux_adam
...
def test_dqc_horqrux(
    ...
    total_magnetization = hamiltonian_factory(n_qubits, detuning=Z)
    # avoid multiple conversion
    (circ, obs, _, _) = bknd_horqrux.convert(circuit, total_magnetization)
    ...
    opt_horqux = dqc_horqrux_adam(circ, obs, init_param_vals)

...
from aquordion.blocks.analog import chain as analog_chain
from aquordion.blocks.analog import kron as analog_kron
from aquordion.exceptions import NotPauliBlockError
...
def chain(*args: Union[AbstractBlock, Generator, List[AbstractBlock]]) -> ChainBlock:
    ...
    from aquordion import X, Y, chain
...
def kron(*args: Union[AbstractBlock, Generator]) -> KronBlock:
    ...
    Example:
    ```python exec="on" source="material-block" result="json"
    from aquordion import X, Y, kron

...
from aquordion.blocks.analog import (
    AnalogBlock,
...
from aquordion.types import PI, OpName, TNumber, TParameter
...
def AnalogInteraction(
    ...
    Constructs a [`InteractionBlock`][aquordion.blocks.analog.InteractionBlock].
...
def _analog_rot(
    ...
    # FIXME: once https://github.com/pasqal-io/aquordion/issues/150 is fixed set default duration
...
def AnalogRX(
    ...
    Shorthand for [`AnalogRot`][aquordion.operations.AnalogRot]:
...
def AnalogRZ(
    ...
    """Analog Z rotation. Shorthand for [`AnalogRot`][aquordion.operations.AnalogRot]:
    ```
    φ=2.4; δ=π; t = φ/δ * 100)

...
def transpile(*fs: Callable) -> Callable:
    ...
    from aquordion import *
    from aquordion.transpile import transpile, flatten, scale_primitive_blocks_only
    ...
    ```python exec="on" source="material-block" result="json"
    from aquordion import *
    from aquordion.transpile import transpile, blockfn_to_circfn, flatten

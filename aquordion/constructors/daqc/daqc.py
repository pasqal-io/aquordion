...
from aquordion.blocks import AbstractBlock, add, chain, kron
from aquordion.blocks.utils import block_is_qubit_hamiltonian
from aquordion.constructors.hamiltonians import hamiltonian_factory
from aquordion.operations import HamEvo, I, N, X
from aquordion.types import GenDAQC, Interaction, Strategy
...
def daqc_transform(
    ...
    Notes:
        ...
        here also use that convention to be consistent with the paper. However, for aquordion
    ...
    Examples:
        ...
        from aquordion import Z, N, daqc_transform

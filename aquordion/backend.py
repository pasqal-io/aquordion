...
from aquordion.blocks.analog import ConstantAnalogRotation, InteractionBlock
from aquordion.circuit import QuantumCircuit
from aquordion.noise import NoiseHandler
from aquordion.parameters import stringify
from aquordion.types import ArrayLike, BackendName, DiffMode, Endianness, Engine, ParamDictType
...
class Backend(ABC):
    ...
    def convert(
        ...
        [here][aquordion.blocks.embedding.embedding]).
        """

        def check_observable(obs_obj: Any) -> AbstractBlock:
            if isinstance(obs_obj, QubitOperator):
                from aquordion.blocks.manipulate import from_openfermion
    ...
    def sample(
        ...
        Arguments:
            ...
            param_values: _**Already embedded**_ parameters of the circuit. See
                [`embedding`][aquordion.blocks.embedding.embedding] for more info.

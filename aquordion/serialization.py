...
from aquordion import QuantumCircuit, operations, parameters
from aquordion import blocks as qadenceblocks
from aquordion.blocks import AbstractBlock
from aquordion.blocks.utils import tag
from aquordion.parameters import Parameter
from aquordion.register import Register
from aquordion.types import SerializationFormat
...
def serialize(obj: SUPPORTED_TYPES, save_params: bool = False) -> dict:
    ...
    import torch
    from aquordion import serialize, deserialize, hea, hamiltonian_factory, Z
    from aquordion import QuantumCircuit, QuantumModel
...
def save(
    ...
    from aquordion import save, load, hea, hamiltonian_factory, Z
    from aquordion import QuantumCircuit, QuantumModel

...
from aquordion.types import DifferentiableExpression, Engine, TNumber
...
class Parameter(Symbol):
    ...
    def __new__(
        ...
        from aquordion.parameters import Parameter, VariationalParameter
    ...
    def __eq__(self, other: object) -> bool:
        from aquordion.utils import isclose
...
def make_differentiable(expr: Expr, engine: Engine = Engine.TORCH) -> DifferentiableExpression:
    ...
    if engine == Engine.JAX:
        from aquordion.backends.jax_utils import jaxify
...
def evaluate(expr: Expr, values: dict | None = None, as_torch: bool = False) -> TNumber | Tensor:
    ...
    Example:
    ```python exec="on" source="material-block" result="json"
    from aquordion.parameters import Parameter, evaluate
...
class ParamMap:
    ...
    ```python exec="on" source="material-block" result="json"
    import sympy
    from aquordion.parameters import ParamMap
    ...
    def _to_dict(self) -> dict:
        from aquordion.serialization import serialize

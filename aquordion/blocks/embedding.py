...
from aquordion.parameters import evaluate, make_differentiable, stringify
from aquordion.types import ArrayLike, DifferentiableExpression, Engine, ParamDictType, TNumber
...
def embedding(
    ...
    # NOTE
    # there are 3 kinds of parameters in aquordion

...
from aquordion.operations import SWAP, I
...
def validate(block: AbstractBlock) -> AbstractBlock:
    ...
    from aquordion.blocks import chain
    from aquordion.operations import X
    from aquordion.transpile import validate
...
def scale_primitive_blocks_only(block: AbstractBlock, scale: sympy.Basic = None) -> AbstractBlock:
    ...
    ```python exec="on" source="above" result="json"
    from aquordion import chain, X, RX
    from aquordion.transpile import scale_primitive_blocks_only
    ...
    ```python exec="on" source="above" result="json"
    from aquordion import add, X, RX
    from aquordion.transpile import scale_primitive_blocks_only
...
def chain_single_qubit_ops(block: AbstractBlock) -> AbstractBlock:
    ...
    Examples:
    ```python exec="on" source="above" result="json"
    from aquordion import hea
    from aquordion.transpile.block import chain_single_qubit_ops

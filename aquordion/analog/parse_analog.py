...
from aquordion.analog.hamiltonian_terms import (
...
from aquordion.operations import HamEvo
from aquordion.register import Register
from aquordion.transpile import apply_fn_to_blocks
...
def _analog_to_hevo(
    ...
    if isinstance(block, AnalogKron):
        ...
        # https://github.com/pasqal-io/aquordion/issues/226
        ops = []

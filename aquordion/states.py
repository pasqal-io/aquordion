...
from aquordion.blocks import ChainBlock, KronBlock, PrimitiveBlock, chain, kron
from aquordion.circuit import QuantumCircuit
from aquordion.execution import run
from aquordion.logger import get_script_logger
from aquordion.operations import CNOT, RX, RY, RZ, H, I, X
from aquordion.types import PI, BackendName, Endianness, StateGeneratorType
from aquordion.utils import basis_to_int
...
def uniform_state(n_qubits: int, batch_size: int = 1) -> Tensor:
    ...
    from aquordion.states import uniform_state
...
def zero_state(n_qubits: int, batch_size: int = 1) -> Tensor:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import zero_state
...
def one_state(n_qubits: int, batch_size: int = 1) -> Tensor:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import one_state
...
def product_state(
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import product_state
...
def rand_product_state(n_qubits: int, batch_size: int = 1) -> Tensor:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import rand_product_state
...
def ghz_state(n_qubits: int, batch_size: int = 1) -> Tensor:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import ghz_state
...
def random_state(
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import random_state, StateGeneratorType
    from aquordion.states import random_state, is_normalized, pmf
...
def uniform_block(n_qubits: int) -> KronBlock:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import uniform_block
...
def one_block(n_qubits: int) -> KronBlock:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import one_block
...
def zero_block(n_qubits: int) -> KronBlock:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import zero_block
...
def product_block(bitstring: str) -> KronBlock:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import product_block
...
def rand_product_block(n_qubits: int) -> KronBlock:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import rand_product_block
...
def ghz_block(n_qubits: int) -> ChainBlock:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import ghz_block
...
def pmf(wf: Tensor) -> Distribution:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import uniform_state, pmf
...
def normalize(wf: Tensor) -> Tensor:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import uniform_state, normalize
...
def is_normalized(wf: Tensor, atol: float = NORMALIZATION_ATOL) -> bool:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import uniform_state, is_normalized
...
def rand_bitstring(N: int) -> str:
    ...
    Examples:
    ```python exec="on" source="material-block" result="json"
    from aquordion.states import rand_bitstring
...
def overlap(s0: torch.Tensor, s1: torch.Tensor) -> torch.Tensor:
    ...
    ```
    """
    from aquordion.overlap import overlap_exact

...
from aquordion.blocks.primitive import AbstractBlock
from aquordion.parameters import Parameter, ParamMap, evaluate
from aquordion.qubit_support import QubitSupport
from aquordion.register import Register
from aquordion.types import Interaction
...
class InteractionBlock(AnalogBlock):
    ...
    To construct, use the [`AnalogInteraction`][aquordion.operations.AnalogInteraction] function.
    """
...
class ConstantAnalogRotation(AnalogBlock):
    ...
    - The general rotation operation [`AnalogRot`][aquordion.operations.AnalogRot]
    - Shorthands for rotatins around an axis:
      [`AnalogRX`][aquordion.operations.AnalogRX],
      [`AnalogRY`][aquordion.operations.AnalogRY],
      [`AnalogRZ`][aquordion.operations.AnalogRZ]
...
class AnalogChain(AnalogComposite):
    def __init__(self, blocks: Tuple[AnalogBlock, ...]):
        ...
        Automatically constructed by the [`chain`][aquordion.blocks.utils.chain]
        function if only analog blocks are given.

        Example:
        ```python exec="on" source="material-block" result="json"
        from aquordion import X, chain, AnalogInteraction

...
from aquordion.blocks import AbstractBlock, KronBlock, chain, kron, tag
from aquordion.operations import PHASE, RX, RY, RZ, H
...
def feature_map(
    ...
    from aquordion import feature_map, BasisSet, ReuploadScaling
